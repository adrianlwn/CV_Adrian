...
\longdescript{Employment of a Gaussian Process (GP) model to calculate the optimal spatial positioning of sensors to study and collect air pollution data in big cities. Validation with data assimilation software. Ongoing Project. 
}
\sectionsep
