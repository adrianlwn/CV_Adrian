...
% Description COmmand 
\newcommand{\descript}[1]{\color{subheadings}\scshape\normalfont {#1\\} }
\newcommand{\longdescript}[1]{\color{subheadings}\scshape\normalfont\small {#1\\} }
...
\newcommand{\namesection}[4]{
	...
	\end{center}
	\vspace{-10pt}
    	\begin{center} \color{headings}\normalfont\fontsize{13pt}{14pt}\selectfont #4
		\end{center}
	\vspace{-13pt}
...
\namesection{Adrian}{Löwenstein}{\href{https://github.com/adrianlwn}{\faGithubSquare{}  github}  | \href{https://www.linkedin.com/in/adrian-löwenstein/ }{\faLinkedinSquare{}  linkedin} |  \href{mailto:adrian.loewenstein@icloud.com}{\faEnvelope{} adrian.loewenstein@icloud.com} |  \faPhoneSquare{} +33 7 67 88 52 57  \\ French Nationality |  Born 21.11.1993 }{``On ne voit bien qu'avec le cœur. L'essentiel est invisible pour les yeux.''}


%%%%%%%%%%%%%%%%%%%% SOFT SKILLS %%%%%%%%%%%%%%%%%%%% 
\section{Soft Skills}
\subsection{Qualities}
\longdescript{Reasoning \mybullet{} Analysis \mybullet{} Adaptability \mybullet{} Curiosity \mybullet{} Creativity }
\sectionsep
\subsection{Language }
...
\descript{Classical Machine Learning \mybullet{} Reinforcement Learning \mybullet{} Deep Learning \mybullet{} Computer Vision \\ \hspace*{3pt} \mybullet{} Probabilistic Inference [Gaussian Processes, Bayesian Optimisation] \mybullet{} Computational Finance \mybullet{} Networking [Routing, TCP-IP] } 
\sectionsep

\subsection{Electrical Engineering}
\descript{Electrical Grid Control \& Modelling \mybullet{} Electricity Market \mybullet{} Energy Storage \mybullet{} Energy Generation\\  \hspace*{3pt} \mybullet{} Model Predictive Control \mybullet{} State Space Control \mybullet{} Computational Optimisation}
\sectionsep

\subsection{Programming}
\descript{Python [Pytorch, Pandas, Numpy, Scikit-Learn] \mybullet{} C \mybullet{} C++ \mybullet{} Matlab [YALMIP] \mybullet{} \LaTeX \mybullet{} Git \mybullet{} Javascript [D3.js]}
\sectionsep
...
\descript{EPFL Electrical Engineering Students Association \mybullet{} EPFL Photography Club }
\sectionsep
\subsection{Others}
\descript{Photography [Digital, Analog] \mybullet{}  Video Making \mybullet{}  Hiking \mybullet{} Skiing \mybullet{} Discovery Travelling [Peru, China, Iran]} 
\sectionsep
...
\subsection{H$_2$O$_2$ Fuel Cell and Electrolyser Analysis and Monitoring}
