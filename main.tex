...
\longdescript{Classical Machine Learning \mybullet{} Reinforcement Learning \mybullet{} Deep Learning \mybullet{} Computer Vision \\ \hspace*{3pt} \mybullet{} Probabilistic Inference [Gaussian Processes, Bayesian Optimisation] \mybullet{} Computational Finance \mybullet{} Natural Language Processing } 
\sectionsep

\subsection{Electrical Engineering}
\longdescript{Electrical Grid Control \& Modelling \mybullet{} Electricity Market \mybullet{} Energy Storage \mybullet{} Energy Generation\\  \hspace*{3pt} \mybullet{} Model Predictive Control \mybullet{} State Space Control \mybullet{} Computational Optimisation}
\sectionsep

\subsection{Programming}
\longdescript{Python [Pytorch, Pandas, Numpy, Scikit-Learn] \mybullet{} C \mybullet{} C++ \mybullet{} Matlab [YALMIP] \mybullet{} \LaTeX \mybullet{} Git \mybullet{} Javascript [D3.js]}
\sectionsep
...
\longdescript{MSc in Computing | Machine Learning }
\sectionsep
\subsection{Ecole Polytechnique Fédérale de Lausanne | EPFL }
\location{Lausanne, Switzerland | July 2018}
\longdescript{MSc in Electrical Engineering  | Smart Grids Science | Average : 5.31 / 6.0}
\sectionsep
...
\sectionsep
\subsection{Others}
\longdescript{Photography [Digital, Analog] \mybullet{}  Video Editing [Final Cut Pro] \mybullet{}  Hiking \mybullet{} Skiing \mybullet{} Discovery Travelling [Peru, China, Iran]} 
\sectionsep
...
\longdescript{Employment of a Gaussian Process (GP) model to calculate the optimal spatial positioning of sensors to study and collect air pollution data in big cities. Validation with data assimilation software. Data Science Institute (DSI). Ongoing Project. 
}
\sectionsep
...
\longdescript{Classification of Offensive Tweets. Achieved the 5th best results for subtask B. Use of state of the art methods such as GRU, RNN or CNN. }
\sectionsep
